...
const h4=await fetchCandles(pair,'4h');
await sleep(300);
...
const r=await analyzePair(PAIRS[i]).catch(e=>({pair:PAIRS[i],h4_candles:0,h1_candles:0,consolidating:false,bias:'error',strength:0,near_sr:false,range_pips:0,avg_volume:0,h4_trend:'unknown'}));
results.push(r);
await sleep(800);
}
